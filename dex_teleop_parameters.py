...
def get_arg_parser():
    ...
    parser.add_argument('--skip-success', action='store_true', help = "Skip the success/failure prompt after stopping each recording. By default, stopping a non-empty recording asks whether the episode succeeded (y/n) and writes a success.txt label into the episode directory.")
